...
# sam3_pick_ros2.py 의 HOME_JOINTS 와 같은 값이어야 한다. 09-12 에 교시로 바꿨는데
# 이 파일이 구 값(71.232, -77.373, 88.429, -100.799, -89.955, -18.064)을 들고 있어서
# 여기로 홈을 보내면 자세가 21.6도 다른 곳으로 갔다 — 파지 보정값의 전제가 깨진다.
