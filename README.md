...
| 담당자 | 담당 파트 | 주요 기여 |
| :---: | :---: | --- |
| 백⁠은⁠주<br>(팀장) | V⁠L⁠A⁠ ⁠·⁠ ⁠R⁠L⁠(⁠강⁠화⁠학⁠습⁠)⁠ ⁠·⁠ ⁠환⁠경⁠제⁠어⁠시⁠스⁠템 | SAM3 비주얼 서보잉 기반 탄피 · 탄두 Pick & Place, 탄두–탄피 나사 체결 PPO 강화학습 환경 · 정책 · 실기 실행, MQTT 기반 온 · 습도 환경제어 폐루프 |
| 김⁠선⁠일 | 3⁠D⁠ ⁠모⁠델⁠링⁠ ⁠·⁠ ⁠I⁠L⁠(⁠모⁠방⁠학⁠습⁠)⁠ ⁠·⁠ ⁠V⁠L⁠A⁠ ⁠·⁠ ⁠R⁠O⁠I⁠ ⁠관⁠제 | 고정대 · 부품 3D 모델링, LeRobot 모방학습 데이터 수집과 완제품 이동, SAM3 인식, ROI 산출 · 환경제어시스템 UI 관제 |
