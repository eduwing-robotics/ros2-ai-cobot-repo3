...
def main():
    ...
    try:
        ...
        print()
        print("========================================")
        print("SAM3 BASKET CRATE PICKUP -> START")
        print("========================================")
        ...
        # The previously recorded Tag-centered WObj position is used
        ...
        print()
        print("========================================")
        print("STEP 7: MOVE TO PLACEMENT POSITION")
        print("========================================")
        ...
        print()
        print("========================================")
        print("BASKET PICKUP -> PLACE -> START RETURN COMPLETE")
        print("========================================")
