...
//     납작해져 영상은 **146px** 폭, 3D 는 **298px** 폭 → **가로 2배** 어긋났다. 주인님이
...
// 두 카메라 PiP 의 공통 시작 크기. 어느 한 카메라 컴포넌트가 다른 쪽 기본값의
// 주인이 되지 않게 창 동작의 공용 경계에 둔다.
export const CAMERA_PIP_DEFAULT = { width: 300, height: 195 };
