...
더 나간다. 실기 담당자 실측(2026-08-05)은 **네모 몸통 맨 위 → 몸통 끝 110mm · 핑거 25mm ·
합 135mm**(원형 어댑터는 뺀 값).
...
**~~정확도 미검증~~ → 실물 실측과 일치한다 (2026-08-05 · 실기 담당자 줄자 실측).**
...
실물 펜던트 설정(실기 담당자 실측): **제조업체 DAHUAN(대환) · 유형 PGI-140 · D1.0 · 말단 1번 포트**.
